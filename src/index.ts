...
export interface RouterCorsConfig {
  allowOrigin?: string | ((arg0: Request) => string);
  allowMethods?: string | ((arg0: Request) => string);
  allowHeaders?: string | ((arg0: Request) => string);
  maxAge?: number;
      ...
      if (this.corsEnabled) {
        if (this.corsConfig.allowOrigin)
          headers.set(
            ...
            typeof this.corsConfig.allowOrigin === 'function'
              ? this.corsConfig.allowOrigin(request)
              : this.corsConfig.allowOrigin
          );
        if (this.corsConfig.allowMethods)
          headers.set(
            'Access-Control-Allow-Methods',
            typeof this.corsConfig.allowMethods === 'function'
              ? this.corsConfig.allowMethods(request)
              : this.corsConfig.allowMethods
          );
        if (this.corsConfig.allowHeaders)
          headers.set(
            'Access-Control-Allow-Headers',
            typeof this.corsConfig.allowHeaders === 'function'
              ? this.corsConfig.allowHeaders(request)
